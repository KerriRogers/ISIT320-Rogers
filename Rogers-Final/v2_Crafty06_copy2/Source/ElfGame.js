...
.factory('elfGameService', function(gameEventService, people, gameWrap) {
	...
	return {
		...
		encounterFood : function(food, count) {
			gameEventService.debugBroadcast('Blood bonus of 3 points!');
			gameEventService.encounterBroadcast('Blood refreshed Sasha');
			return true;
		},
		...
		encounter : function(village) {
			...
			gameEventService.debugBroadcast('Grave Attack points: ' + village.tower.hitPoints);
