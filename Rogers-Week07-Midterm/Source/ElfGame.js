...
.factory('elfgame', function(gameEventService, people) { 'use strict';
	...
	return {
        ...
        encounterFood : function(food) {
            gameEventService.debugBroadcast("Power Gem!");
            gameEventService.encounterBroadcast('2 Health Points!');
            return true;
        },
		...
		encounter : function(village) {
			...
			gameEventService.debugBroadcast('Flaming Head hit points: ' + village.tower.hitPoints);
		...
		start : function(mapGrid) {			
			...
			Crafty.game = this;
			Crafty.background('rgb(150, 20, 120)');
