...
Crafty.c('PlayerCharacter', { 
    init: function() { 'use strict';
        ...
        this.bind('NewDirection', function(data) {
            ...
            if (data.x > 0) {
                Crafty.game.changeDirectionMessage("SquareHead is slicing Right");
                this.playAnimation('PlayerMovingRight', animation_speed, -1);
            } else if (data.x < 0) {
                Crafty.game.changeDirectionMessage("SquareHead is slicing Left");
                this.playAnimation('PlayerMovingLeft', animation_speed, -1);
            } else if (data.y > 0) {
                Crafty.game.changeDirectionMessage("SquareHead is slicing Down");
                this.playAnimation('PlayerMovingDown', animation_speed, -1);
            } else if (data.y < 0) {
                Crafty.game.changeDirectionMessage("SquareHead is slicing Up");
    ...
    visitVillage: function(data) { 'use strict';
        ...
        Crafty.game.reportEvent("Found Flaming Head!: " + data[0].obj._entityName);
